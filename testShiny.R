...
# pull request apres avoir importer le depot quelqu'un (dans l'eadresse url a la creation du projet)
# nottament le cas des Hacktoberfest ou il en faut 5. Les modifs sont proposés, non permanente
# Load packages -----------------------------------------------------
